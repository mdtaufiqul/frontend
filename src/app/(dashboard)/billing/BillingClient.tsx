            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                {canManage && (
                    <div className="flex gap-3">
                        <Button variant="outline" className="gap-2"><Download size={18} />Export Report</Button>
                        <Button onClick={handleCreateInvoice} className="gap-2 shadow-lg shadow-primary-200"><Plus size={18} />Create Invoice</Button>
                    </div>
                )}
            </div>
