...
const Dashboard: React.FC = () => {
  ...
  const fetchDashboardData = React.useCallback(async () => {
    ...
    try {
      ...
      // 2. Fetch Schedule (Personal or Clinic-wide)
      let newSchedule: any[] = [];
        ...
        if (apptRes) {
          ...
          newSchedule = appointments.map((appt: any) => {
            ...
            return {
              ...
              rawDate: appt.date.split('T')[0] // Passing YYYY-MM-DD
            };
  ...
  useEffect(() => {
    ...
    const handleUpdate = () => {
      console.log('[Dashboard] Real-time appointment update received');
      fetchDashboardData();
    };
  ...
  return (
    <div className="h-[calc(100vh-7rem)] flex flex-col gap-2 overflow-hidden pb-1">
      ...
      <div className="flex-1 grid grid-cols-12 gap-3 min-h-0">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                {/* <span className="bg-red-50 text-red-600 text-[10px] font-bold px-1.5 py-0.5 rounded-full border border-red-100">HIGH RISK</span> */}
                              </div>
                    ...
                    <div key={i} className="relative flex sm:gap-4 mb-3 group last:mb-0">
                      ...
                      <div
                        className={clsx(
                          ...
                          // slot.type === 'Block'
                          //   ? "bg-slate-50 border-slate-100 border-dashed hover:bg-slate-100"
        ...
        {/* RIGHT COLUMN: INSIGHTS & WAITING ROOM (4/12) */}
